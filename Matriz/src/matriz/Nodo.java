...
class MatrizOrtogonal {
    ...
    public void insertar(String placa, String color, String linea, String modelo, String propietario) {
        ...
        if (root == null) {
            root = nuevo;
            System.out.println("Nodo guardado con éxito en fila 0, columna 0");
            return;
        }
        ...
        while (temp != null) {
            ...
            if (lastRight.derecha == null) {
                ...
                System.out.println("Nodo guardado con éxito en fila " + fila + ", columna " + (columna + 1));
                return;
            }
            temp = temp.abajo;
            fila++;
        ...
        System.out.println("Nodo guardado con éxito en fila " + (fila + 1) + ", columna 0");
    }
            ...
            while (innerTemp != null) {
                if (innerTemp.placa.equalsIgnoreCase(valor) || innerTemp.color.equalsIgnoreCase(valor)
                    ...
                    return "Nodo encontrado en fila " + fila + ", columna " + columna + " con datos: "
                            + "Placa: " + innerTemp.placa + ", Color: " + innerTemp.color + ", Línea: " + innerTemp.linea
